...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('update/{employeeId}/{documentId}/{referenceDate}/{status}', 'Panel\ChecklistController@update')->middleware('can:onlyAdmin')->name('checklist.update');
    Route::get('download/{employeeId}/{referenceDate}/{finalFileName}', 'Panel\ChecklistController@download')->middleware('can:onlyAdmin')->name('checklist.download');
