                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            ...
                            @can('onlyAdmin')
                                <li>
                                    ...
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a href="{{ route('document-providers.index') }}">Prestadores de servi&ccedil;os</a></li>
                                        <li><a href="{{ route('document-employees.index') }}">Funcion&aacute;rios</a></li>
                                    </ul>
                                </li>
                                <li>
                            ...
                            @can('onlyProvider')
                                <li>
                                    <a href="{{ route('employee.index') }}"><i class="fa fa-list-alt"></i>
...
<script src="{{ asset('js/cdnjs/bootstrap3-typeahead.min.js') }}"></script>

<!-- Custom Theme Scripts -->
<script src="{{ asset('build/js/custom.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('js/waiting-dialog.js') }}" type="text/javascript"></script>
