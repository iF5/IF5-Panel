                        ...
                        @forelse($documents as $document)
                            <tr>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" style="min-width: 220px;">
                                            <li style="padding: 5px;">
                                                Enviado em : <strong>08/10/2017 09:45:21</strong>
                                            </li>
                                            <li style="padding: 5px;">
                                                Reenviado em : <strong>08/10/2017 09:45:21</strong>
                                            </li>
                                            <li style="padding: 5px;">
                                                Reprovado em :
                                            </li>
                                            <li style="padding: 5px;">
                                                Aprovado em : <strong>08/10/2017 09:45:21</strong>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href=""
                                       class="btn btn-warning btn-md modal-document-upload" data-toggle="modal"
                                       data-target="#upload"
                                       title="Validar Documento">Validar
                                    </a>


                                    <input class="entityId" type="hidden" name="employeeId"
                                           value="1">
